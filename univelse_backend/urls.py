"""
URL configuration for univelse_backend project.
...
schema_view = get_schema_view(
   openapi.Info(
      title="UnivHat API",
      default_version='v1',
      description="This API is used to manage students' courses and evaluations",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="hectorvladitok@gmail.com"),
